...
/**
 * @class Player2
 * @brief Represents player 2 in the game, managing player-specific state and actions.
 *
...
private:
    int player_index;   ///< Player index (1 or 2)
...
public:
    /**
     * @brief Constructs a Player2 object with game parameters.
     * @param player_index The player index (should be 2).
     * @param cols Number of columns in the board.
     * @param rows Number of rows in the board.
     * @param max_steps Maximum allowed steps.
     * @param num_shells Number of shells available.
     */
    Player2(int player_index, size_t rows, size_t cols, size_t max_steps, size_t num_shells);
     ...
     * @return Player index (should be 2).
     */
    int getID() const;
};
